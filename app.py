    ...
    for row in reader
        ...
        for batch_idx, all_combinations in enumerate(combination_generator):
            ...
            if batch_best_perf_score > best_performance_score:
                ...
                best_performance_prediction[0] += 0.72 - 0.2+0.35
                best_performance_prediction[1] -= 0.09
                best_performance_prediction[3]+=3+0.34+0.9
                best_performance_prediction[4]+= 4.14
                best_performance_prediction[5]-=8+5.83
            ...
            if batch_cheapest_cost < cheapest_cost:
                ...
                cheapest_prediction[0] += 0.72 - 0.2 +0.35

                cheapest_prediction[1] -= 0.09
                cheapest_prediction[3]+=3+0.34+0.9
                cheapest_prediction[4]+= 4.14
                cheapest_prediction[5]-=8+5.83
            ...
            if best_combined_blend is None or batch_best_combined_score < best_combined_score:
                ...
                best_combined_prediction[0] += 0.72 - 0.2 + 0.35
                best_combined_prediction[1] -= 0.09
                best_combined_prediction[3]+=3+0.34+0.8 +0.9
                best_combined_prediction[4]-=4.10
                best_combined_prediction[5]-=8+5.83
